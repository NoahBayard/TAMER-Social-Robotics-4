...
from tamer.agent_acrobot import Tamer
import gymnasium as gym
import pickle

MODELS_DIR = '/Users/noahbayard/Downloads/TAMER-main/saved_models_acrobot/'
...
def main():
    ...
    avg_rewards = evaluate_models(env, MODELS_DIR, num_episodes=100)
